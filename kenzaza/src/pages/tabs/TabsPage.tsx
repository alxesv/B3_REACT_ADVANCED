...
const TabsPage = () => {
  ...
  const codeString = `
  <Tabs tabs={tabNames} tabContent={tabContents} height='35' width='25' />
  ...
  const data: DataProp[] = [
      { prop: 'tabs', description: 'Array of tab names', type: 'string[]', default: 'N/A' , options: 'N/A' },
      { prop: 'tabContent', description: 'Array of content for each tab', type: 'React.ReactNode[]', default: 'N/A', options: 'N/A' },
      { prop: 'width', description: 'Width of the tabs', type: 'string', default: '20', options: 'N/A' },
      { prop: 'height', description: 'Height of the tabs', type: 'string', default: '20', options: 'N/A' }
  ];
  return (
