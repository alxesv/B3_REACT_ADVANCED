...
const Loader: React.FC<LoaderProps> = ({
  ...
  if (type === 'progress') {
    ...
    <div className={`progress-animation ${colorType}`} style={{height: `${height}rem` , width: `${width}%`}}>
    </div>
      </div>
</div>
    );
  ...
  return (
    <div className={`spinner ${colorType}`} style={{height: `${radius}rem`, width: `${radius}rem`}}></div>
